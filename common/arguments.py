...
def parse_args():
    ...
    parser.add_argument('-d', '--dataset', default='custom', type=str, metavar='NAME', help='target dataset') # h36m or humaneva
    ...
    parser.add_argument('--evaluate', default='pretrained_243_h36m_detectron_coco_wtraj.bin', type=str, metavar='FILENAME', help='checkpoint to evaluate (file name)')
    ...
    parser.add_argument('--viz-subject', default='GH013110_original_cut_cut.MP4', type=str, metavar='STR', help='subject to render')
    ...
    parser.add_argument('--viz-video', default='./inference/input_directory/GH013110_original_cut_cut.MP4', type=str, metavar='PATH', help='path to input video')
    parser.add_argument('--viz-skip', type=int, default=0, metavar='N', help='skip first N frames of input video')
    # parser.add_argument('--viz-output', type=str, metavar='PATH', help='output file name (.gif or .mp4)')
    parser.add_argument('--viz-output', default='output.mp4', type=str, metavar='PATH', help='output file name (.gif or .mp4)')
    # parser.add_argument('--viz-export', type=str, metavar='PATH', help='output file name for coordinates')
    parser.add_argument('--viz-export', default='output_3d', type=str, metavar='PATH', help='output file name for coordinates')
